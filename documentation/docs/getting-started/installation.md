...
Download pre-built daemon binaries from the [GitHub Releases](https://github.com/cognisoc/mullama/releases) page.

=== "Linux (x86_64)"

    ```bash
    curl -LO https://github.com/cognisoc/mullama/releases/latest/download/mullama-linux-x86_64.tar.gz
...
=== "Linux (ARM64)"
    ...
    ```bash
    curl -LO https://github.com/cognisoc/mullama/releases/latest/download/mullama-linux-aarch64.tar.gz
...
=== "macOS (Apple Silicon)"
    ...
    ```bash
    curl -LO https://github.com/cognisoc/mullama/releases/latest/download/mullama-macos-aarch64.tar.gz
...
=== "macOS (Intel)"
    ...
    ```bash
    curl -LO https://github.com/cognisoc/mullama/releases/latest/download/mullama-macos-x86_64.tar.gz
...
=== "Windows"
    ...
    ```powershell
    Invoke-WebRequest -Uri "https://github.com/cognisoc/mullama/releases/latest/download/mullama-windows-x86_64.zip" -OutFile mullama.zip
