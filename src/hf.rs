//! Shared Hugging Face GGUF downloader, cache, and model-spec support.
//!
//! This is the reusable Hugging Face integration layer consumed by both
//! daemon-facing APIs and CLI workflows.
//!
